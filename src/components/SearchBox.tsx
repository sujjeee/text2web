            ...
            <div className='px-4 w-full justify-center items-center flex '>
                <div className='max-w-xl w-full '>
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            className="block w-full  p-4 pl-10 text-sm font-medium text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="create me a simple todo website..."
                            value={searchValue}
